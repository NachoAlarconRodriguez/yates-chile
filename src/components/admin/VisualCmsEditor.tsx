                ...
                <div className="bg-white rounded-3xl border border-slate-200/90 shadow-sm p-6 sm:p-8 space-y-8">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                      ...
                      />
                      {(() => {
                        const rawUrl = (currentBanner.brochure_url || '').trim();
                        const isLoaded = Boolean(
                          rawUrl && (
                            isValidDriveOrDropboxUrl(rawUrl) ||
                        ...
                        return (
                          <a
                            href={normalizeBrochureUrl(rawUrl)}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-emerald-50 hover:bg-emerald-100/80 border border-emerald-200/90 text-emerald-800 text-xs font-semibold shrink-0 shadow-2xs transition cursor-pointer"
                            title="Brochure cargado correctamente (Clic para abrir en nueva pestaña)"
                          >
                            <div className="w-5 h-5 rounded-full bg-emerald-500 text-white flex items-center justify-center shrink-0 shadow-2xs">
                              <Check className="w-3 h-3 stroke-[3]" />
                            </div>
                            <span>Brochure Cargado</span>
                          </a>
                        );
                      })()}
                    </div>
